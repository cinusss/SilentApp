...
export default function ActionNotLoggedModal({
  navigation,
  modalNotLoggedOpen,
          ...
          <View style={styles.modalPartTwo}>
            <View style={styles.modalSpaceText}>
              <Text style={styles.modalTextBig}>
                Nie jesteś zalogowany na właściwe konto.
              </Text>
              <Text style={styles.modalTextSmall}>
                Przejdź do zakładki Publikuj i zaloguj się na konto przypisane
                do aplikacji.
              </Text>
            </View>
            ...
            <View style={styles.modalSpaceButton}>
              <View style={styles.spaceButton}>
                <TouchableOpacity
                  ...
                  onPress={() => {
                    setModalNotLoggedOpen(false);
                    actionHandler();
                  }}>
                  <Text style={styles.modalTextButton}>Przejdź</Text>
                </TouchableOpacity>
              </View>
            </View>
          </View>
