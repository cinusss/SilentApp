...
export default function ActionErrorModal({modalErrorOpen, setModalErrorOpen}) {
  return (
    <Modal visible={modalErrorOpen} transparent={true} animationType="slide">
      <ScrollView>
          ...
          <View style={styles.modalPartTwo}>
            <View style={styles.modalSpaceText}>
              ...
              <Text style={styles.modalTextSmall}>
                Spróbuj ponownie. Jeżeli zobaczysz ponownie ten komunikat,
