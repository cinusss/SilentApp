...
export default function PublishedModal({navigation, modalOpen, setModalOpen}) {
  const actionHandler = () => {
    navigation.reset({
      index: 0,
        ...
        <View style={styles.modalPartTwo}>
          <View style={styles.modalSpaceText}>
            <Text style={styles.modalTextBig}>
              Twoje zdjęcie oczekuje w kolejce do opublikowania!
            </Text>
            <Text style={styles.modalTextSmall}>
              Kliknij poniższy przycisk, aby wykonać polubienia i uaktywnić
              wybrane zdjęcie na grupie zaangażowania.
            </Text>
          </View>
